...
hi Cursor ctermfg=236 ctermbg=255 cterm=NONE guifg=#2E2F31 guibg=#f8f8f0 gui=NONE
hi Visual ctermfg=NONE ctermbg=241 cterm=NONE guifg=NONE guibg=#2E2F31 gui=NONE
hi CursorLine ctermbg=16 cterm=NONE guifg=NONE guibg=#2E2F31 gui=NONE
...
hi Comment ctermfg=147 ctermbg=NONE cterm=NONE guifg=#5C5E5F guibg=NONE gui=NONE
