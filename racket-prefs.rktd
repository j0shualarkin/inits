(
 ...
 (plt:framework-pref:framework:last-directory #"/home/joshua/")
 ...
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:comment #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (160 119 225) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:keyword #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (255 255 0) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 ...
 (|plt:DrRacket 7.4-splash-max-width| 1002)
 (plt:framework-pref:drracket:get-module-path-from-user-size (600 600))
 (plt:framework-pref:drracket:open-module-path-last-used "com")
 ...
 (plt:framework-pref:htdp:test-engine-window-size #hash((((0 0 1920 1080)) . (#f 624 1029)) (#f . (#f 624 1029)) (((0 0 1920 1080) (-1920 0 1920 1080)) . (#f 939 1029))))
 (plt:framework-pref:htdp:test-engine-window-position #hash((((0 0 1920 1080)) . (0 648 13)) (#f . (0 648 13)) (((0 0 1920 1080) (-1920 0 1920 1080)) . (1 968 13))))
 ...
 (plt:framework-pref:drracket:console-previous-exprs
  (
   ("(make-color 167 173 101)")
   ("(circle 25 'solid (make-color 167 173 101))")
   ("(circle 25 'solid (make-color 167 173 120))")
   ("(circle 25 'solid (make-color 210 173 101))")
   ("(circle 25 'solid (make-color 210 200 101))")
   ("(circle 25 'solid (make-color 210 200 200))")
   ("(circle 25 'solid (make-color 210 150 200))")
   ("(circle 25 'solid (make-color 230 150 200))")
   ("(circle 25 'solid (make-color 200 150 200))")
   ("    (define elons-vehicle (make-vehicle 2018 \"SpaceX\" \"Falcon-9 Heavy\"))")
   ("(require 2htdp/image)")
   ("(define (try n m p)\n    (circle 25 'solid (make-color n m p)))")
   ("(try 220 100 220)")
   ("(try 240 100 220)")
   ("(try 240 100 240)")
   ("(try 240 120 240)")
   ...
   ("(+ 28 4 10 5 12)")
   ("(match '()\n    [`,'() \"dog\"]\n    [else \"cat\"])")
   ("(define monus (λ (n1 n2)\n                  (cond ((zero? n2) n1)\n                        ((eqv? n1 n2) 0)\n                        (else (add1 (monus (sub1 n1) n2))))))")
   ("(monus 5 2)")
   ("(monus 3 2)")
   ("(ex 'x '(x y z))")
   ("(match '(91 2 3)\n    [null #f]\n    [`(,n ...) #:when (eqv? x n) 2]\n    [`(,n ...) #t])")
   ...
   ("")
   ("(require 2htdp/image)")
   ("(make-color 230 90 250)")
   ("(square 25 'solid (make-color 230 90 250))")
   ("(define (col a b c)\n    (square 25 'solid (make-color a b c)))")
   ("(col 220 90 250)")
   ("(col 220 90 210)")
   ("(col 240 90 210)")
   ("(col 180 90 210)")
   ...
   ("(draw ps3)")
   ("(send 'gold red)")
   ("(make-color 230 100 60)")
  ))
 (plt:framework-pref:framework:exit-when-no-frames #t)
 (plt:framework-pref:framework:standard-style-list:font-size #2(#hash((((1920 1080) (1920 1080)) . 12) (((1920 1080)) . 12)) 12))
 ...
 (plt:framework-pref:drracket:unit-window-size-percentage 394700891/833492260)
 (plt:framework-pref:framework:recently-opened-files/pos
  (
   (#"/home/joshua/testcolors.rkt" 0 0)
   (#"/home/joshua/Class/211/labs/lab5.rkt" 0 0)
   (#"/home/joshua/cl" 0 0)
   (#"/home/joshua/Class/311/labs/lab3.rkt" 0 0)
   (#"/home/joshua/Downloads/assignment 5 - recursion.rkt" 0 0)
   (#"/home/joshua/Class/211/hw/a5.rkt" 0 0)
   (#"/home/joshua/Class/P423/compiler2019/racket/R1-RA/build-interference.rkt" 0 0)
   (#"/home/joshua/Class/P423/compiler2019/racket/R1-RA/uncover-live.rkt" 0 0)
   (#"/home/joshua/Class/P423/compiler2019/racket/R1-RA/allocate-registers.rkt" 0 0)
   (#"/home/joshua/Class/P423/compiler2019/course-compiler/A1-run-tests.rkt" 0 0)
   (#"/home/joshua/Class/P423/compiler2019/racket/R1-RA/r1ra.rkt" 0 0)
   (#"/home/joshua/Class/P423/compiler2019/course-compiler/tests/r1_10.rkt" 0 0)
   (#"/home/joshua/Class/P423/compiler2019/course-compiler/compiler.rkt" 0 0)
   (#"/home/joshua/Class/P423/compiler2019/course-compiler/tests/r1_14.rkt" 0 0)
   (#"/home/joshua/Class/P423/compiler2019/course-compiler/utilities.rkt" 0 0)
   (#"/home/joshua/Class/211/labs/lab4.rkt" 0 0)
  ))
 (plt:framework-pref:drracket:window-size #hash((((-1920 0 1920 1080) (0 0 1920 1080)) . (#f 1920 1055)) (((0 0 1920 1080)) . (#f 939 1029)) (#f . (#f 939 1029)) (((0 0 1920 1080) (-1920 0 1920 1080)) . (#f 939 1029))))
 (plt:framework-pref:drracket:window-position #hash((((-1920 0 1920 1080) (0 0 1920 1080)) . (0 0 0)) (((0 0 1920 1080)) . (0 968 13)) (#f . (0 968 13)) (((0 0 1920 1080) (-1920 0 1920 1080)) . (1 13 13))))
)
